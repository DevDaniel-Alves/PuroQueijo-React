                ...
                <article className="d-flex justify-content-between gap-5">
                    <section className="w-50">
                        <div className="input__dados mb-3">
                            ...
                            <input type="email" className="input_name form-control" id="titulo" placeholder="Titulo"></input>
                        </div>

                        <div className="input__dados mb-3">
                            <label for="resumo" className="form-label">Resumo</label>
                            <input type="email" className="input_name form-control" id="resumo" placeholder="Resumo"></input>
                        </div>
                    ...
                    <section className="w-50">
                        <div className="input__dados mb-3">
                            ...
                            <input type="email" className="input_name form-control" id="urlFoto" placeholder="Url da Foto"></input>
                        </div>

                        <div className="input__dados mb-3">
                            <label for="emissao" className="form-label">Emissao</label>
                            <input type="email" className="input_name form-control" id="emissao" placeholder="Emissao"></input>
                        </div>
                    </section>
                </article>
