                ...
                <h1 className="text-center">Redes Sociais</h1>                
                    <section className="mx-auto w-50">
                        <div className="input__dados mb-3">
                            ...
                            <input type="text" className="input_name form-control" id="Nome" placeholder="Nome"></input>
                        </div>

                        <div className="input__dados mb-3">
                            <label for="Usuario" className="form-label">Usuario</label>
                            <input type="email" className="input_name form-control" id="Usuario" placeholder="Usuario"></input>
                        </div>
